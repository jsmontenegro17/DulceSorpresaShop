				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count"><span><?php echo count($typeCombos);?></span> Productos</div>
							<input type="hidden" id="type" value="<?php echo $_GET['type']."s" ?>">
						...
						<div class="product_grid">
							...
							<?php foreach($typeCombos as $combo){ ?>
...
<script src="public/js/shop/typeCombo.js"></script>
