					  ...
					  <div class="tab-pane fade show active" id="nav-cart" role="tabpanel" aria-labelledby="nav-cart-tab"><br>
					  	<div class="cart_container">
					  		...
					  		<div class="jumbotron">
							 	 ...
							 	 <p class="lead">Tu sugerencia fue enviada con exito.</p>
							 	 <hr class="my-4">
							  	<p>Apartir de ahora sin en 30 minutos no nos comunicamos por via telefonica, email o whatsapp, envianos un mensaje personal a nuestro whatsapp <a class="" href="https://wa.link/j8qs9d">+57 310 526 1209</a></p>
...
<script src="public/js/contact/response.js"></script>
